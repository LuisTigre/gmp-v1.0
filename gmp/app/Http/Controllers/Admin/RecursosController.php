...
class RecursosController extends Controller
{
    ...
    public function index()
    {
       ...
       $listaTurmas = Turma::where('ano_lectivo',$epoca->ano_lectivo)->get();       
       $avalicoes = collect([]);
        
        foreach($listaTurmas as $turma) {     
           $avalicoes->push(Turma::classificaoAnual($turma->id,'III'));
        }
        
       return view('admin.recursos.index',compact('listaMigalhas','listaArtigos'));
