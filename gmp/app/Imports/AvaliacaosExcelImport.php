...
use App\Professor;
use App\Disciplina;
use App\Imports\AvaliacaosImport;
...
class AvaliacaosExcelImport implements WithMultipleSheets
{
    /**
    * WithMappedCells,
   ...
   //          if($user->admin == 'S' || $user->director_turma == 'S' && $user->email == $professor->email){ 
