        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Importa vários disciplinas de um arquivo Excel</div>

                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{route('disciplinas.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
