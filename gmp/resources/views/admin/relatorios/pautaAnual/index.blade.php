...
use Dompdf\Dompdf;
     ...
     <th class='centro' scope='col' rowspan='3' >Nº</th>  
      ...
      <th class='centro' scope='col' rowspan='3'>
        ...
        if($classe->nome == "10ª"){
         ...
         ?>
          <th style='font-size:12px;font-weight:bold;'scope='col' colspan='7'class='centro'>{{$value->acronimo}}</th><?php 
         }else if(isset($disc_terminadas_10) && $disc_terminadas_10->contains($value->id)){?>          
          <th scope='col' colspan='1'class='centro'>{{$value->acronimo}}</th><?php 
         }else{?>
          <th scope='col' colspan='5'class='centro'>{{$value->acronimo}}</th><?php 
         }
        ...
        /*11ª CLASSE*/
          ...
          <th scope='col' colspan='1' rowspan='3' class='centro'><p class='vtexto' style='margin:0px -15px;font-size:11px;'>{{$value->acronimo}}</p></th><?php 

          /*DISCIPLINA TERMINAL COM ANTECEDENTE*/
         }else if($disc_terminal->isNotEmpty() && $disc_anterior->isNotEmpty()){?>
         
          <th scope='col' colspan='8'class='centro'>{{$value->acronimo}}</th><?php 

          /*DISCIPLINA TERMINAL SEM ANTECEDENTE*/
         }else if($disc_terminal->isNotEmpty() && $disc_anterior->isEmpty()){?>

          <th scope='col' colspan='7'class='centro'>{{$value->acronimo}}</th><?php 

          /*DISCIPLINA DE CONTINUIDADE COM ANTECEDENTE*/
         }else if($disc_terminal->isEmpty() && $disc_anterior->isNotEmpty()){ ?>
         
          <th scope='col' colspan='6'class='centro'>{{$value->acronimo}}</th><?php 
         ...
         if($disc_terminada_10->isNotEmpty() || $disc_terminada_11->isNotEmpty()){ ?>
          ...
          <th scope='col' colspan='1' rowspan='3' class='centro'>
            <p class='vtexto' style='margin:0px -15px;font-size:11px;'>{{$value->a}}cronimo</p>
          </th><?php 
         /*DISCIPLINA TERMINAL COM ANTECEDENTE*/
         }else if($disc_terminal->isNotEmpty() && $disc_anterior->isNotEmpty()){          
          if($qtd == 2){?> 

          <th scope='col' colspan='9'class='centro'>{{$value->acronimo}}</th><?php 
          }else{ ?>
         ...
         if($disc_terminada_10->isNotEmpty() || $disc_terminada_11->isNotEmpty() || $disc_terminada_12->isNotEmpty()){ ?>
          ...
          <th scope='col' colspan='1' rowspan='3' class='centro' style='font-size:5px'><p class='vtexto' style='margin:0px -15px;font-size:11px;'>{{$value->acronimo}}</p></th><?php 
         /*DISCIPLINA TERMINAL COM ANTECEDENTE*/
         }else if($disc_terminal->isNotEmpty() && $disc_anterior->isNotEmpty()){          
          
          if($qtd == 3){ ?> 

            <th scope='col' colspan='10'class='centro'>{{$value->acronimo}}</th><?php 
          }else if($qtd == 2){?>
    ...
    <tr><?php 
      ...
      foreach($listaCabecalho2 as $key => $value){
        ...
        <th scope='col' rowspan='2' class='centro'><p style='font-size:11px;' class='vtexto'>CA10ª</p></th><?php 
        ...
        <th scope='col' style='font-size:5px' rowspan='2' class='centro'><p class='vtexto' style='margin:0px -15px;font-size:11px;'>CA10ª</p></th><?php 
         }
        if($disc_terminada_10->isEmpty()){?>
          ...
          <th scope='col' rowspan='2' class='centro'>
            <p class='vtexto' style='margin:0px -15px;font-size:11px;'>CA$modulo_nome[1]ª</p>
            </th><?php 
        }
        if($disc_terminal->isNotEmpty()){?>
        <th scope='col' rowspan='2' class='centro'>
          <p class='vtexto' style='margin:20px -15px;font-size:11px;'>EXAME</p>
        </th>
        <th scope='col'rowspan='2' class='centro'>
          <p class='vtexto' style='margin:0px -15px;font-size:11px;font-size:11px;'>CFD</p>
        </th><?php
         }
        ...
        if($qtd == 2){?>
           <th scope='col' style='font-size:5px' rowspan='2' class='centro'>
            <p class='vtexto' style='margin:0px -15px;font-size:11px;'>CA10ª</p>
           </th>
            <th scope='col' style='font-size:5px' rowspan='2' class='centro'>
              <p class='vtexto' style='margin:0px -15px;font-size:11px;'>CA11ª</p>
              </th><?php 

        }else if($qtd == 1){?>
            <th scope='col' style='font-size:5px' rowspan='2' class='centro'><p class='vtexto' style='margin:0px -15px;font-size:11px;'>CA11ª</p></th><?php 
        }
        ...
        <th scope='col' colspan='2' class='centro'>F</th>  
        <th scope='col' rowspan='2' class='centro' style='font-size:8px'>
          <p class='vtexto' style='margin:0px -13.5px;'>CF</p>
        </th>
        <th scope='col' rowspan='2' class='centro' style='font-size:8px'>
          <p class='vtexto' style='margin:0px -13.5px;'>PG</p></th>
        <th scope='col' rowspan='2' class='centro'><p class='vtexto' style='margin:0px -15px;font-size:11px;'>CA$modulo_nome[1]ª</p>
          </th><?php 
        }
        ...
        if($disc_terminada_10->isNotEmpty() || $disc_terminada_11->isNotEmpty() || 
          ...
          if($qtd == 2){?>
              <th scope='col' style='font-size:7px' rowspan='2' class='centro'>C11</th>
              <th scope='col' style='font-size:7px' rowspan='2' class='centro'>C12</th><?php 
          }else if($qtd == 1){?>
              <th scope='col' style='font-size:7px' rowspan='2' class='centro'>C12</th><?php 
          }
        ...
        <th scope='col' rowspan='2' class='centro'>CF</th>
        <th scope='col' rowspan='2' class='centro'>PG</th>
        <th scope='col' rowspan='2' class='centro' style='font-size:6px'>C{{$modulo_nome[1]}}</th><?php 
        }
    ...
    <tr><?php 
      foreach($listaCabecalho2 as $key => $value){
        if($classe->nome == '10ª'){?>
          ...
          <th scope='col' class='centro'>I</th><?php 
     ...
     <tbody><?php 
      ...
      ?>
      <tr style='font-size:10px;background:{{$fundo}};'><?php 
