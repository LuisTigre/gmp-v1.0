...
av.fnj3, 
av.fj3,
year(now())-year(al.data_de_nascimento) as idade,ROUND((av.mac1 + av.p11 + av.p12) / 3,
            1) AS ct1a,
    ROUND((av.mac1 + av.p11) / 2,
            1) AS ct1b,
    ROUND(((av.mac1 + av.p11 + av.p12) / 3 + (av.mac2 + av.p21 + av.p22) / 3) / 2,
            1) AS ct2a,
    ROUND(((av.mac1 + av.p11) / 2 + (av.mac2 + av.p21) / 2) / 2,
            1) AS ct2b,
    ROUND((((av.mac1 + av.p11 + av.p12) / 3 + (av.mac2 + av.p21 + av.p22) / 3) / 2 + (av.mac3 + av.p31) / 2) / 2,
            1) AS ct3a,
    ROUND((((av.mac1 + av.p11) / 2 + (av.mac2 + av.p21) / 2) / 2 + (av.mac3 + av.p31) / 2) / 2,
            1) AS ct3b,
    ROUND((((av.mac1 + av.p11 + av.p12) / 3 + (av.mac2 + av.p21 + av.p22) / 3) / 2 + (av.mac3 + av.p31) / 2) / 2,
            1) AS mtca,
    ROUND((((av.mac1 + av.p11) / 2 + (av.mac2 + av.p21) / 2) / 2 + (av.mac3 + av.p31) / 2) / 2,
            1) AS mtcb,
    ROUND((((av.mac1 + av.p11 + av.p12) / 3 + (av.mac2 + av.p21 + av.p22) / 3) / 2 + (av.mac3 + av.p31) / 2) / 2 * 0.6,
            1) AS sessentaa,
    ROUND((((av.mac1 + av.p11) / 2 + (av.mac2 + av.p21) / 2) / 2 + (av.mac3 + av.p31) / 2) / 2 * 0.6,
            1) AS sessentab,
    ROUND(av.p32 * 0.4, 1) AS quarenta,
    ROUND((((av.mac1 + av.p11 + av.p12) / 3 + (av.mac2 + av.p21 + av.p22) / 3) / 2 + (av.mac3 + av.p31) / 2) / 2 * 0.6 + av.p32 * 0.4,
            1) AS notafinala,
    ROUND((((av.mac1 + av.p11) / 2 + (av.mac2 + av.p21) / 2) / 2 + (av.mac3 + av.p31) / 2) / 2 * 0.6 + av.p32 * 0.4,
            1) AS notafinalb,
